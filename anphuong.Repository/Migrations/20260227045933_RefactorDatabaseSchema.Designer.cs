...
namespace anphuong.Repository.Migrations
{
    ...
    [Migration("20260227045933_RefactorDatabaseSchema")]
            ...
            modelBuilder.Entity("anphuong.Core.Domains.Entities.Inventory", b =>
                {
                    ...
                    b.HasIndex("VariantId1")
                        .IsUnique()
                        .HasFilter("[VariantId1] IS NOT NULL");
            ...
            modelBuilder.Entity("anphuong.Core.Domains.Entities.Customer", b =>
                {
                    ...
                    b.HasOne("anphuong.Core.Domains.Entities.User", null)
                        .WithOne("Customer")
                        .HasForeignKey("anphuong.Core.Domains.Entities.Customer", "UserId1");
            ...
            modelBuilder.Entity("anphuong.Core.Domains.Entities.DetailImage", b =>
                {
                    ...
                    b.HasOne("anphuong.Core.Domains.Entities.Product", null)
                        .WithOne("DetailImage")
                        .HasForeignKey("anphuong.Core.Domains.Entities.DetailImage", "ProductId1");
            ...
            modelBuilder.Entity("anphuong.Core.Domains.Entities.Inventory", b =>
                {
                    ...
                    b.HasOne("anphuong.Core.Domains.Entities.Variant", null)
                        .WithOne("Inventory")
                        .HasForeignKey("anphuong.Core.Domains.Entities.Inventory", "VariantId1");
